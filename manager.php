...
<body onload="showBrowseSearchBar()">
	<div class="container">
		<?php include 'php/head.php';?>
	<div class="columns " style="">
		<div class="column col-2" style=""><?php include 'php/manager/offcanvas.php';?></div>
		<div class="column col-10 col-md-12" id="content-area"><?php include 'php/manager/viewInventory.php';?></div>
	</div>
	<div id="disp"></div>
</div>
